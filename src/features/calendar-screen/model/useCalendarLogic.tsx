...
import {currentDateStore} from "@/features/calendar-date-controls/model/currentDateStore";
// import { useEventStore } from "@/features/create-event/model";
import {useMemo} from "react";
import {EventInfoModalForm} from "../../../entities/event/ui/event-info-modal-form/EventInfoModalForm";
import {useModalStore} from "@/shared/lib/modal-storage";
import {EventForm} from "@/features/create-event/ui/event-form";
