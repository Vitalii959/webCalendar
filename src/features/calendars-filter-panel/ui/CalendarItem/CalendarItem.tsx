...
import {CalendarsFilterForm} from "@/features/calendars-filter-panel/ui/CalendarsFilterForm";
...
export const CalendarItem = ({item}: CalendarItemType) => {
  ...
  const selectedIds = selectedCalendarsStore((s) => s.selectedIds);
  const {toggleSelectedIds} = selectedCalendarsStore.getState();
